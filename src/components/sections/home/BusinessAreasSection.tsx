...
import { Pickaxe, Leaf, Truck, FlaskConical } from "lucide-react";
...
import chemi5 from "@/components/images/chemi5.jpeg";
  ...
  return (
    <section className="py-24 lg:py-32 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Image strip */}
        <div className="mt-16 grid grid-cols-2 lg:grid-cols-4 gap-3 overflow-hidden">
          {[
